...
const Navbar = ({ toggleSidebar }) => {
  return (
    <div className="bg-primary1 shadow-md py-4 pr-4 md:pr-0">
      <div className="flex justify-between items-center px-2 gap-2">
        ...
        <div className="flex items-center justify-center bg-primary2 text-grayText px-1.5 py-1.5 gap-2 min-w-[200px] max-w-xl w-[100%] rounded-md">
          ...
          <input
            type="text"
            className="bg-transparent w-full outline-none border-none text-gray-300"
          ></input>
        </div>
        <div className="flex items-center gap-x-2">
          <div className="relative">
            <div className="absolute top-[3px] right-[5px] w-2 h-2 rounded-full bg-red-500"></div>
